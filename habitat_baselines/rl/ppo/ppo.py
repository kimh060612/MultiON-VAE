...
class PPOExploration(nn.Module):
    def __init__(
        self,
        actor_critic,
        clip_param,
...
class PPOExpAttention(nn.Module):
    def __init__(
        self,
        actor_critic,
        clip_param,
...
class PPOTrajUncertain(nn.Module):
    def __init__(
        self,
        actor_critic,
        clip_param,
        ...
        self.ppo_epoch = ppo_epoch
        self.num_mini_batch = num_mini_batch
        self.num_mini_steps = num_mini_steps
    ...
    def update(self, rollouts):
        ...
        for e in range(self.ppo_epoch):
            data_generator = rollouts.recurrent_generator(
                advantages, self.num_mini_batch, self.num_mini_steps
            )
